...
class _SearchWidgetState extends State<SearchWidget>
  ...
  void initState() {
    ...
    _containerWidth = Tween<double>(begin: 80, end: 350).animate(
      CurvedAnimation(
        parent: _animationController,
    ...
    _containerColor =
        ColorTween(begin: const Color(0xFF38003C), end: Color(0xFFFFFFFF))
            .animate(
          CurvedAnimation(
            parent: _animationController,
            curve: const Interval(0.4, 1.0),
    ...
    _iconColor = ColorTween(begin: Colors.white, end:Color(0xFF38003C)).animate(
      CurvedAnimation(
        parent: _animationController,
        curve: const Interval(0.4, 1.0),
      ),
              ...
              child: SlideTransition(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: Color(0xFF38003C).withOpacity(0.2),
                        blurRadius: 12,
                      )
                    ],
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(
                                fontSize: 20,
                                color: Color(0xFF38003C).withOpacity(0.4),
                              ),
                            ),
                            onChanged: (value) {
                              if (value.isNotEmpty) {
                          ...
                          child: Column(
                            children: [
                              Divider(
                                ...
                                endIndent: 16.0,
                                height: 3.0,
                                color: Color(0xFF38003C).withOpacity(0.5),
                              ),
                              const ListTile(
                                leading: Padding(
